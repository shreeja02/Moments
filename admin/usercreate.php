...
<div class="wrapper">
 ...
 <form method="post" action="usercreateaction.php" enctype="multipart/form-data">
<div class="container">
...
<input type="radio" name="txttype" value="user">User
  ...
  <input type="text" class="form-control" required placeholder="Enter 10 digit mobileno" name="txtmno"/>
  <br>
